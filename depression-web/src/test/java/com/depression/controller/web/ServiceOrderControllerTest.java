...
public class ServiceOrderControllerTest
{
    ...
    public void getServiceOrderByPage() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/ServiceOrder/getServiceOrderByPage.json")
    			.param("pageIndex", "1")
    			.param("pageSize", "10")
    ...
    @Test
    public void refundServiceOrder() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/ServiceOrder/refundServiceOrder.json")
    			.param("no", "1234512345")
    			.param("rate", "50")
    			.param("reclaimServer", "1")
    			)
    	.andReturn();
    ...
    public void cancelServiceOrder() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/ServiceOrder/cancelServiceOrder.json")
    			.param("no", "1234512345")
    			)
    	.andReturn();
    ...
    @Test
    public void handleExceptionServiceOrder() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/ServiceOrder/handleExceptionServiceOrder.json")
    			.param("no", "1234512345")
    			)
    	.andReturn();
    ...
    @Test
    public void exportServiceOrderServiceOrder() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/ServiceOrder/exportServiceOrder.json")
    			.param("createTime", "2017-3-16 00:00:00")
    			.param("endTime", "2017-3-24 00:00:00")
    			)
    	.andReturn();
