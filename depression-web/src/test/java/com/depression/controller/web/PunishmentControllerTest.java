...
public class PunishmentControllerTest
{
    ...
    @Test
    public void addDisableMessageDays() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/Punishment/addDisableMessageDays.json")
    			.param("mid", "4460")
    			.param("days", "20")
    			)
    	.andReturn();
    ...
    @Test
    public void obtainDisableMessageDays() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/Punishment/obtainDisableMessageDays.json")
    			.param("mid", "4460")
    			)
    	.andReturn();
    ...
    @Test
    public void clearDisableMessageDays() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/Punishment/clearDisableMessageDays.json")
    			.param("mid", "4460")
    			)
    	.andReturn();
