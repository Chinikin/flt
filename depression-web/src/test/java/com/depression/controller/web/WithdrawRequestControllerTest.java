...
@WebAppConfiguration 
public class WithdrawRequestControllerTest
{
    ...
    @Test
    public void capitalWithdrawOperationByNo() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/CapitalWithdrawRequest/capitalWithdrawOperationByNo.json")
    			.param("no", "3066543421212672")
    			)
    	.andReturn();
