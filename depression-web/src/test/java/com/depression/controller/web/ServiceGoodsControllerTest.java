...
@WebAppConfiguration 
public class ServiceGoodsControllerTest
{
    ...
    @Test
    public void obtainPriceScope() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/ServiceGoods/obtainPriceScope.json")
    			)
    	.andReturn();
    ...
    @Test
    public void modifyPriceScope() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/ServiceGoods/modifyPriceScope.json")
    			.param("sgpsId", "1")
    			.param("floor", "1")
    			.param("ceiling", "1000")
    			)
