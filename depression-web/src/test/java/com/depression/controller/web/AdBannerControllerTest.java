...
@WebAppConfiguration 
public class AdBannerControllerTest
{
    ...
    public void list() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/adBanner/list.json")
    			.param("showLocation", "2")
    			.param("pageIndex", "1")
    			.param("pageSize", "10")
    			)
    	.andReturn();
    ...
    public void getPsychoByName() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/adBanner/getPsychoByName.json")
    			.param("name", "的")
    			)
    	.andReturn();
    ...
    public void getTestingByTitle() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/adBanner/getTestingByTitle.json")
    			.param("title", "心理")
    			)
    	.andReturn();
