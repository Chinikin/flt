...
@WebAppConfiguration 
public class CapitalPlatformUnitFundStatisticsControllerTest
{
    ...
    public void searchMemberTest() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/Statistics/getPlatformCash.json")
    			)
    	.andReturn();
    ...
    @Test
    public void selectPlatformIncomeAndExpensesStatistics() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/Statistics/selectPlatformIncomeAndExpensesStatistics.json")
    			.param("startDate", "2015-1-1 00:00:00")
    			.param("endDate", "2016-10-1 00:00:00")
    			)
    	.andReturn();
