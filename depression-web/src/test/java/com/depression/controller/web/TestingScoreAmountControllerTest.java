...
@WebAppConfiguration 
public class TestingScoreAmountControllerTest
{
    ...
    @Test
    public void listByMid() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/testingScoreAmount/listByMid.json")
    			.param("mid", "6830")
    			)
    	.andReturn();
    ...
    public void listByTestingId() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/testingScoreAmount/listByTestingId.json")
    			.param("testingId", "14")
    			)
    	.andReturn();
    ...
    @Test
    public void selectByMidAndTestingId() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/testingScoreAmount/selectByMidAndTestingId.json")
    			.param("testingId", "14")
    			.param("mid", "6830")
    			)
    	.andReturn();
    ...
    public void save() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/testingScoreAmount/save.json")
    			.param("testingId", "33")
    			.param("mid", "6830")
    			.param("score", "70")
    ...
    public void update() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/testingScoreAmount/update.json")
    			.param("scoreId", "795")
    			.param("score", "50")
    ...
    public void changeStatus() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/testingScoreAmount/changeStatus.json")
    			.param("scoreId", "795")
    			.param("isDelete", "1")
