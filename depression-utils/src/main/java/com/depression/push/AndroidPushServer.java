...
public class AndroidPushServer
{
	...
	public static void pushSingleDevice(PushMsg msg) throws PushClientException, PushServerException
	{
		...
		try
		{
			...
			notification.put("notification_builder_id", msg.getNotificationBuilderId());
			notification.put("notification_basic_style", msg.getNotificationBasicStyle());
			JSONObject jsonCustormCont = new JSONObject();
			jsonCustormCont.put("content", msg.getCustomContent()); // 自定义内容，key-value
			notification.put("custom_content", jsonCustormCont);

			PushMsgToSingleDeviceRequest request = new PushMsgToSingleDeviceRequest().addChannelId(msg.getChannelId()).addMsgExpires(new Integer(3600 * 5)). // message有效时间
