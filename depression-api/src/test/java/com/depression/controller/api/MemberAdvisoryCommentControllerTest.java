...
@WebAppConfiguration 
public class MemberAdvisoryCommentControllerTest
{
    ...
    public void savex() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/MemberAdvisoryComment/savex.json")
    			.param("advisoryId", "3")
    			.param("mid", "4460")
    			.param("commentContent", "测试")
    			.param("parentId", "38")
    			)
    	.andReturn();
    ...
    @Test
    public void listByPagex() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/MemberAdvisoryComment/listByPagex.json")
    			.param("mid", "4461")
    			.param("advisoryId", "3")
    			.param("pageIndex", "1")
    			.param("pageSize", "10")
