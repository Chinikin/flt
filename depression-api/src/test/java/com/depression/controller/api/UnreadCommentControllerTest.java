...
@WebAppConfiguration 
public class UnreadCommentControllerTest
{
    ...
    @Test
    public void obtainUnreadCount() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/UnreadCommentController/obtainUnreadCount.json")
    			.param("mid", "7475")
    			)
    	.andReturn();
    ...
    @Test
    public void deleteUnreadComment() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/UnreadCommentController/deleteUnreadComment.json")
    			.param("unreadId", "512")
    			)
    	.andReturn();
    ...
    @Test
    public void getUnreadCommentList() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/UnreadCommentController/getUnreadCommentList.json")
    			.param("mid", "7475")
    			.param("pageIndex", "1")
    			.param("pageSize", "10")
    			)
