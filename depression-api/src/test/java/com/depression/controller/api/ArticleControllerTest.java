...
public class ArticleControllerTest
{
    ...
    @Test
    public void obtainArticlesNewV1() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/Article/V1/obtainArticlesNew.json")
    			.param("pageIndex", "1")
    			.param("pageSize", "10")
    ...
    @Test
    public void obtainArticleDetail() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/Article/V1/obtainArticleDetail.json")
    			.param("articleId", "178")
    			)
    	.andReturn();
    ...
    @Test
    public void getArticleListAndCollection() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/ArticleCollection/getArticleListAndCollection.json")
    			.param("mid", "9463")
    			.param("pageIndex", "1")
    			.param("pageSize", "10")
    			)
