...
public class TestingResultControllerTest
{
    ...
    public void getTestingResult() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/testingResult/getTestingResult.json")
    			.param("testingId", "16")
    			.param("mid", "9463")
    			)
    	.andReturn();
    ...
    public void saveEntireTestingResult() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/testingResult/saveEntireTestingResult.json")
    			.param("testingId", "33")
    			.param("mid", "5904")
    			.param("selJson", "[{\"questionId\": 518,\"optionId\": 1709},"
		    					+ "{\"questionId\": 519,\"optionId\": 1714},"
		    					+ "{\"questionId\": 520,\"optionId\": 1719},"
		    					+ "{\"questionId\": 521,\"optionId\": 1726},"
		    					+ "{\"questionId\": 522,\"optionId\": 1732}]")
    			)
    	.andReturn();
