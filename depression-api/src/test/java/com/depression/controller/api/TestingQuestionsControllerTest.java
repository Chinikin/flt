...
@WebAppConfiguration 
public class TestingQuestionsControllerTest
{
    ...
    @Test
    public void listAllQuestionByTestingId() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/testingQuestions/listAllQuestionByTestingId.json")
    			.param("testingId", "33")
    			)
    	.andReturn();
