...
public class TestingTypeControllerTest
{
    ...
    @Test
    public void getFunnyTestingType() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/testingType/getFunnyTestingType.json")
    			)
    	.andReturn();
    ...
    @Test
    public void getStuTestType() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/testingType/getStuTestType.json")
    			)
    	.andReturn();
