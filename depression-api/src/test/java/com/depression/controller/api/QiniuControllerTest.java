...
public class QiniuControllerTest
{
    ...
    @Test
    public void obtainFileUploadToken() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/Qiniu/obtainFileUploadToken.json")
    			)
    	.andReturn();
    ...
    @Test
    public void obtainPictureUploadToken() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/Qiniu/obtainPictureUploadToken.json")
    			)
    	.andReturn();
