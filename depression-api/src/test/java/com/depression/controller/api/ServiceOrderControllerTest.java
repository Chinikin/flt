...
public class ServiceOrderControllerTest
{
    ...
    @Test
    public void obtainServiceOrderBroadcast() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/serviceOrder/V1/obtainServiceOrderBroadcast.json")
    			)
    	.andReturn();
    ...
    public void getPaymentInfo() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/serviceOrder/getPaymentInfo.json")
    			.param("mid", "6042")
    			.param("calledId", "8443")
    			.param("price", "50.00")
    			)
