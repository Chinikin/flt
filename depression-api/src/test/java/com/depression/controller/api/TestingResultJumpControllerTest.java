...
@WebAppConfiguration 
public class TestingResultJumpControllerTest
{
    ...
    @Test
    public void getTestingResult() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/testingResult/jump/getTestingResult.json")
    			.param("mid", "6830")
    			.param("testingId", "25")
    			)
    	.andReturn();
    ...
    @Test
    public void saveEntireTestingResult() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/testingResult/jump/saveEntireTestingResult.json")
    			.param("mid", "6830")
    			.param("testingId", "16")
    			.param("selJson", "	[{\"questionId\": 225,\"optionId\": 880}]")
    			)
    	.andReturn();
