...
public class ClientLogControllerTest
{
    ...
    @Test
    public void newClientLog() throws Exception{
    	MvcResult mvcResult = 
    	mockMvc.perform(post("/ClientLog/newClientLog.json")
    			.param("type", "0")
    			.param("marking", "inviting-cai")
    			.param("log", "logloglogloglogloglogloglogloglogloglog")
    			)
    	.andReturn();
