 ...
 * @project rest_demo
 */
package com.depression.base.ucpaas.client;
...
import com.depression.base.ucpaas.models.AppBill;
import com.depression.base.ucpaas.models.Callback;
import com.depression.base.ucpaas.models.ClientBill;
import com.depression.base.ucpaas.models.TemplateSMS;
import com.depression.base.ucpaas.models.VoiceCode;
...
public class JsonReqClient extends AbsRestClient {
	...
	public String callback(String accountSid, String authToken, String appId,
			...
			String maxallowtime, String ringtoneID, String lastReminTime, String endPromptToneID, String caller) {
		// TODO Auto-generated method stub
		String result = "";
		DefaultHttpClient httpclient=getDefaultHttpClient();
		try {
			...
			callback.setLastReminTime(lastReminTime);
			callback.setEndPromptToneID(endPromptToneID);
			callback.setType("1");
			callback.setRecord("1");
			callback.setCaller(caller);
			Gson gson = new Gson();
