...
public class FileService
{
	...
	{
		String requestUrl = uploadFileUrl.replace("ACCESS_TOKEN", WeixinUtil.getToken()).replace("TYPE", fileType);
	...
	{
		return dwonloadFileURL.replace("ACCESS_TOKEN", WeixinUtil.getToken()).replace("MEDIA_ID", mediaId);
	}
}
